...
<div class="privacy-policy-content container mx-auto px-4 py-8">
    <h2>Overview</h2>
    <p>
        <strong>Rehema Rescue CBO</strong> privacy policies align with The <strong>Data Protection Act 2019</strong>, <strong>PBO Act</strong>,
    ...
    <ul>
        ...
        <li><strong>General email:</strong> Donations and help mail.</li>
        <li><strong>DPO / Privacy contact:</strong> (to be provided)</li>
    </ul>
    ...
    <ul>
        ...
        <li>Legal obligation (e.g., regulatory reporting required by the <strong>PBO Act</strong> or taxation laws);</li>
    ...
    <p><strong>NOTE:</strong> All processing follows the <strong>Data Protection Act’s</strong> principles: lawfulness, fairness,
    ...
    <p><strong>NOTE:</strong> When transferring data outside Kenya, we will only do so where the transfer complies
        with the <strong>Data Protection Act</strong> requirements (adequate safeguards, contracts, or explicitly informed
        consent).
    </p>
    ...
    <ul>
        ...
        <li>If not satisfied with our response, you may lodge a complaint with the <strong>Office of the Data
            Protection Commissioner (ODPC)</strong> via <a href="https://www.odpc.go.ke">https://www.odpc.go.ke</a> or official complaints
            portals.
        </li>
    </ul>
</div>
