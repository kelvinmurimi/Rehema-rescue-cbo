...
<div class="container-fluid py-5">
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 what-we-do-section wow fadeIn" data-wow-delay="0.1s">
                <div class="content-overlay">
                    ...
                    <div class="d-flex mt-4 wow fadeIn" data-wow-delay="0.7s">
                        <a class="btn btn-primary py-3 px-4 me-3" href="">Volunteer With Us</a>
                        <a class="btn btn-secondary py-3 px-4 text-white" href="">Partner With Us</a>
                    </div>
                </div>
            </div>
        </div>
